...
function Particle(x, y, radius, color) {
  ...
  this.update = function (particles) {
    ...
    if (_utils__WEBPACK_IMPORTED_MODULE_0___default.a.distance(mouse.x, mouse.y, this.x, this.y) < 200 && this.opacity < 0.2) {
      this.opacity += 0.02;
...
function resolveCollision(particle, otherParticle) {
  ...
  var yDist = otherParticle.y - particle.y; //Prevents Overlap of particles

  if (xVelocityDiff * xDist + yVelocityDiff * yDist >= 0) {
    //Get the angle between colliding particles
    var angle = -Math.atan2(otherParticle.y - particle.y, otherParticle.x - particle.x); //Stores the mass of both particles in variables

    var m1 = particle.mass;
    var m2 = otherParticle.mass; //Velocity before equation

    var u1 = rotate(particle.velocity, angle);
    var u2 = rotate(otherParticle.velocity, angle); //Velocity after 1 dimensional collision equation
